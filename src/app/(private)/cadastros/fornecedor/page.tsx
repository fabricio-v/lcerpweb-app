...
import useSearchFornecedor from "@/hooks/useSearchFornecedores";
...
function CadastrosFornecedor() {
  const { push } = useRouter();
  const isMobile = useIsMobile();

  const { loadFornecedores, data, loading } = useSearchFornecedor();
