...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        gotham: ["var(--font-gotham-book)", "sans-serif"],
        gothamBlack: ["var(--font-gotham-black)", "sans-serif"],
        gothamBold: ["var(--font-gotham-bold)", "sans-serif"],
      },
      colors: {
        ...
        "lc-gray": "rgb(var(--lc-gray))",
        "lc-gray-light": "rgb(var(--lc-gray-light))",
        "lc-header-background": "rgb(var(--lc-header-background))",
